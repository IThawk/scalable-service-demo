...
import com.scalable.c4redic.strategy.RoundRobinSelectStrategy;
import com.scalable.c4redic.strategy.SelectStrategy;
...
public class RedicNode {
	...
	public RedicNode(JedisPool master, List<JedisPool> slaves, SelectStrategy selectStrategy) {
		this.master = master;
		this.slaves = slaves;
	...
	public RedicNode(String masterConnStr, List<String> slavesConnStrs, SelectStrategy selectStrategy) {
