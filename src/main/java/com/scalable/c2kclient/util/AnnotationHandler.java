package com.scalable.c2kclient.util;
...
public interface AnnotationHandler<C, K, V> {
	...
	public void handleMethodAnnotation(Class<? extends Object> clazz, Method method, Annotation annotation, TranversorContext<C, K, V> context);

	public void handleClassAnnotation(Class<? extends Object> clazz, Annotation annotation, TranversorContext<C, K, V> context);
